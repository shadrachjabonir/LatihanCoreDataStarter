...
class MemberProvider {
    ...
    func getAllMember(completation: @escaping(_ members: [MemberModel]) -> Void) {
    ...
    func getMember(_ id: Int, completation: @escaping(_ members: MemberModel) -> Void) {
        let taskContext = newTaskContext()
        taskContext.perform {
            let fetchRequest = NSFetchRequest<NSManagedObject>(entityName: "Member")
